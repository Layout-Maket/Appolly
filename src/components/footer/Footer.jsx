                        ...
                        <div className="container-footer">
                            <ul className="footer__contact-list">
                                <li className="footer__contact-item">
                                    <a className="footer__contact-link" href="mailto:info@youremail.com">info@youremail.com</a>
                                </li>
                                <li className="footer__contact-item">
                                    <a className="footer__contact-link" href="tel:8803216559985">+880 321 655 9985</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="container-footer">
                            <div className="footer__content-inner">
                                <div className="footer__content-logo">
                                    <h6 className="footer__content-title footer-title">Logo</h6>
                                    <p className="footer__content-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra nunc ante velit vitae. Est tellus vitae, nullam lobortis enim.</p>
                                    <ul className="footer__social-list">
                                        <li className="footer__social-item">
                                            <svg className='footer__social-img' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_35_73)">
                                            <path d="M14 13.5H16.5L17.5 9.5H14V7.5C14 6.47 14 5.5 16 5.5H17.5V2.14C17.174 2.097 15.943 2 14.643 2C11.928 2 10 3.657 10 6.7V9.5H7V13.5H10V22H14V13.5Z" fill="#fff"/>
                                            </g>
                                            <defs>
                                ...
                                <div className="footer__content-links">
                                    <h6 className="footer__content-title footer-title">quick link</h6>
                                    <ul className="footer__content-list">
                                        <li className="footer__content-item">
                                            <a className="footer__content-link" href="#">About</a>
                                        </li>
                                        <li className="footer__content-item">
                                            <a className="footer__content-link" href="#">Features</a>
                                        </li>
                                        <li className="footer__content-item">
                                            <a className="footer__content-link" href="#">Screenshot</a>
                                        </li>
                                        <li className="footer__content-item">
                                            <a className="footer__content-link" href="#">Blog</a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="footer__content-news">
                                    <h6 className="footer__content-title footer-title">news letter</h6>
                                    <p className="footer__content-text">Subscribe our newsletter to get our latest update & news</p>
                                    <form className="footer__content-form">
                                        <input className="footer__content-input" placeholder="Your email address" type="text" />
                                        <button className="footer__content-btn">
                            ...
                            <div className="footer__content-copyright">
                                ...
                                <p className="footer__copyright-text">Copyright 2021 .Ojjomedia. All Right Reserved.</p>
